...
In this study to find out who does more pushups, on average: a line player or a skill player? We took the data collected from the 30 players, which included weight and amount of pushups done in 2 minutes. Next, the data was used to construct a box plot to visually compare the groups: the skill players preformed better. After, a t test to test the significance of the averages of both groups was conducted and computed a p-value less than 0.05 which suggested that there is evidence for the alternative hypothesis--and fail to accept the null as true. The alternative hypothesis is there is significant differences between the average of pushups preformed by line players and skill players. Therefore we can conclude that the answe to the research question is that skill players do more pushups, on average.
