...
For my graphical method, I will use a boxplot to show the spread of the discrete data (pushups) to determine which group has the highest data set. As for numerics, computing the mean will give us the avrages of the groups to compare, and conducting the t test will tell us if these groups prform differently from eachother.
